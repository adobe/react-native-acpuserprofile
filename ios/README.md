...
```
cd sample/ACPUserProfileSample/ && npm install && react-native run-ios
```
...
or
```
cd sample/ACPUserProfileSample/ && npm install
```
...
```
cd sample/ACPUserProfileSample/ && npm install && react-native run-android
```
